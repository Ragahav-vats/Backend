...
const { create, view, details, update, chnageStatus, destroy } = require('../../controllers/admin/material.controllers');
...
var router = express.Router();
 ...
 module.exports = server => {
    ...
    router.post('/change-status', upload.none(), chnageStatus);
