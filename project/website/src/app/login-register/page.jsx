                        ...
                        <form onSubmit={loginHandler} autoComplete='off'>
                            ...
                            <div className="login_submit">
                               <Link href="forgot-password">Lost your password?</Link>
                                ...
                                <button type="submit" disabled={loginButton ? 'disabled' : ''}>{loginButton ? 'Loading...' : 'Login'}</button>
                ...
                <div className="col-lg-6 col-md-6">
                    <div className="account_form register">
                        ...
                        <form onSubmit={registerHandler} autoComplete='off'>
                            ...
                            <div className="login_submit">
                                <button type="submit" disabled={registerButton ? 'disabled' : ''}>{registerButton ? 'Loading...' : 'Register'}</button>
                            </div>
                        </form>
                    </div>    
                </div>
