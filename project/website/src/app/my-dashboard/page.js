    ...
    useEffect(() => {
        ...
        .then((result) => {         
            if(result.data._status == true){
                ...
                setSelectedTitle(result.data_data.gender);
                                                ...
                                                <form id="personal_information" autoComplete="off" noValidate="noValidate" className="bv-form" onSubmit={updateProfile}>
                                                    ...
                                                    <div className="col-xl-12">
                                                        <div className="form-group has-feedback">
                                                            ...
                                                            <input type="text" className="form-control" value={userProfile.email} id="email"  placeholdere="sultankhan.wscube@gmail.com" readOnly="readOnly" data-bv-field="email" />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div className="col-xl-12">
                                                        <div className="form-group has-feedback">
                                                            ...
                                                            <input type="text" className="form-control numeric" 
                                                           defaultValue={userProfile.mobile_number} id="mobile_number" maxLength="15" name="mobile_number" data-bv-field="mobile_number" />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div className="col-xl-12">
                                                        <div className="form-group has-feedback">
                                                            ...
                                                            <input type="text" className="form-control" name="address" defaultValue={userProfile.address} id="address"  data-bv-field="address" />
                                                        </div>
                                                    </div>
                                    ...
                                    <div className="account_form login_form_container">
                                        ...
                                        <form method="POST" acceptCharset="UTF-8" id="change_password" className="bv-form" autoComplete="off" noValidate="noValidate" onSubmit={changePassword}>
                                            ...
                                            <div className="form-group has-feedback">
                                                ...
                                                <input type="password" className="form-control" name="current_password" id="current_password" data-bv-field="currentpassword"/>
                                            </div>
